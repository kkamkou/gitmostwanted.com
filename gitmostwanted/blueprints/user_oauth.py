...
# @todo #1:15min move the before_request method to a general place or a middleware
@app.before_request
...
# @todo #2:15min move the after_request method to a general place or a middleware
@app.after_request
